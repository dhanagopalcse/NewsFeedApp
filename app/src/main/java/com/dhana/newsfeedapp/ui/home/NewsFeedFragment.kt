package com.dhana.newsfeedapp.ui.home
...
import com.dhana.newsfeedapp.databinding.NewsfeedfragmentBinding
...
import com.dhana.newsfeedapp.utils.EndlessRecyclerOnScrollListener
...
class NewsFeedFragment : BaseFragment<NewsfeedfragmentBinding>() {
    ...
    override fun setBinding(): NewsfeedfragmentBinding =
        NewsfeedfragmentBinding.inflate(layoutInflater)
    ...
    private var TAG:String=NewsFeedFragment::class.java.simpleName
    ...
    override fun onResume() {
        super.onResume()
        Log.e(TAG, "setupRecyclerView: --------------+++++------------------."+Constants.view_mode)
        if(Constants.view_mode.equals("grid")){
    ...
    private fun setupRecyclerView() {
        ...
        viewNewsAdapter.setOnItemClickListener { news ->
                    ...
                    when (response) {
                        is NetworkState.Success -> {
                            ...
                            response.data?.let { newResponse ->
                                ...
                                viewNewsAdapter.differ.submitList(newResponse.articles.toList())
                    ...
                    when (response) {
                        is NetworkState.Success -> {
                            ...
                            response.data?.let { searchResponse ->
                                EspressoIdlingResource.decrement()
                                viewNewsAdapter.differ.submitList(searchResponse.articles.toList())
                                mainViewModel.totalPage =
